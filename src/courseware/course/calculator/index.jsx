  ...
  render() {
    const hints = (
      <Popover id="popover-basic">
        <Popover.Title as="h3">Hints</Popover.Title>
        <Popover.Content>
          <ul>
    ...
    return (
      <div className="container calc-main fixed-bottom py-4" style={{ zIndex: 100 }}>
        <div className="d-flex justify-content-end">
          <Button
            onClick={() => this.setState((state) => ({ showCalculator: !state.showCalculator }))}
            aria-controls="calculator_wrapper"
            aria-expanded={this.state.showCalculator}
        ...
        <Collapse in={this.state.showCalculator}>
          <div id="calculator_wrapper" className="w-100 bg-light p-4">
            <form onSubmit={this.handleSubmit} className="d-flex justify-content-around" type="" id="calculator">
              ...
              <OverlayTrigger trigger="click" placement="top" overlay={hints}>
                <Button
                  title="Hints"
                  variant="outline-info"
                  size="sm"
