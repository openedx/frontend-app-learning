...
export default class Calculator extends Component {
  ...
  render() {
    return (
      <div className="calculator calc-main" style={{ zIndex: 100 }}>
        <div className="d-flex justify-content-end">
          <Collapsible.Advanced className="w-100">
            <div className="container-fluid text-right">
              <Collapsible.Trigger tag="a" className="calculator-trigger bg-light py-2 px-3">
